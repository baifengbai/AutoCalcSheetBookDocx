...
if type1 == 1:  # 截面属性，1为圆管，2为方管
    ...
    if lambda1 <= 150:
        mathtemp = r'\lambda = \frac{L}{i_x} = {' + rf'{l1} \over {round(hzbj, 1)} ' + r'}=' + str(
    ...
    mathtemp = r'\sigma = \frac{N}{A} = {' + rf'{n1} \over {round(mj, 1)}' + r'}=' + str(round(n1 / mj, 1)) + r'(MPa)'
    ...
    if sigma2 < fp:
        mathtemp = r'\frac{N}{\psi A} ={' + rf'{n1} \over {psi[ceil(lambda1 / xik1)]} \times {round(mj, 1)}' + r'}=' + str(
